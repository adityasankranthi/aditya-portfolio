    ...
    >
        ...
        <div className="relative bg-primary rounded-2xl m-px flex flex-col flex-grow">
            <div className="relative h-48 w-full">
                <Image src={project.imageUrl} alt={project.title} layout="fill" className="object-cover transition-transform duration-500 group-hover:scale-110" />
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-4 flex space-x-2">
                    <button onClick={onDetailsClick} className="flex-1 bg-primary text-text py-2 px-4 rounded-full text-sm font-semibold hover:bg-accent hover:text-white transition-colors border border-white/10">
                        View Details
                    </button>
                    <a href={project.projectUrl} target="_blank" rel="noopener noreferrer" className="flex-1 text-center bg-accent text-white py-2 px-4 rounded-full text-sm font-semibold hover:bg-accent-hover transition-colors">
                        Visit Site
                    </a>
                </div>
            </div>
